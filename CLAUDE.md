...
packages/
  cli/              # xd-toolkit CLI (C2) — setup, init, doctor, update, score
    ...
    skills/core/    #   Bundled 23 skills (Impeccable 18 + Vercel 2 + figma-plugin-dev 1 + vml-thrive-feedback 1 + brand-extract 1) + Superpowers plugin
...
| C2 | `xd-toolkit` CLI | **Done** | setup, init, doctor, update, score commands working. 23 skills bundled. |
